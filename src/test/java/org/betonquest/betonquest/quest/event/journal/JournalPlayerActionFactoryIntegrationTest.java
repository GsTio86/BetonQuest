...
class JournalPlayerActionFactoryIntegrationTest {
    /**
     ...
     */
    public JournalPlayerActionFactoryIntegrationTest() {
    }
    ...
    private QuestEventFactoryAdapter createJournalEventFactory(final BetonQuestLogger logger) {
        final JournalActionFactory journalEventFactory = new JournalActionFactory(new SingletonLoggerFactory(logger), betonQuest, InstantSource.fixed(now), saver);

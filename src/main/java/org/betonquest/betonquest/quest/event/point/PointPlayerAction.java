 ...
 */
public class PointPlayerAction implements PlayerAction {
     ...
     */
    public PointPlayerAction(final NotificationSender pointSender, final String categoryName, final String category, final VariableNumber count, final Point pointType) {

 ...
 */
public class VelocityPlayerAction implements PlayerAction {
    /**
     ...
     */
    public VelocityPlayerAction(final VectorData vector, final VectorDirection direction, final VectorModification modification) {
        this.vector = vector;

 ...
 */
public class PartyPlayerAction implements PlayerAction {
     ...
     */
    public PartyPlayerAction(final VariableNumber range, @Nullable final VariableNumber amount, final ConditionID[] conditions, final EventID... events) {
        this.range = range;
        this.amount = amount;

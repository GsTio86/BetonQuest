 ...
 */
public class GlobalPointPlayerAction implements Action {
    /**
     * The global data
     */
     ...
     */
    public GlobalPointPlayerAction(final String category, final VariableNumber count, final Point pointType) {

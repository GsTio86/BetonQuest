 ...
 */
public class WeatherPlayerAction implements Action {
     ...
     */
    public WeatherPlayerAction(final Weather weather, final Selector<World> worldSelector, final VariableNumber duration) {

 ...
 */
public class ChestTakePlayerAction extends AbstractChestEvent implements Action {
     ...
     */
    public ChestTakePlayerAction(final CompoundLocation compoundLocation, final Item... items) {

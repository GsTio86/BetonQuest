 ...
 */
public class OnlineProfileRequiredPlayerAction implements PlayerAction {
    /**
     ...
     */
    public OnlineProfileRequiredPlayerAction(final BetonQuestLogger log, final PlayerAction event, final QuestPackage questPackage) {
        this.log = log;
        this.event = event;

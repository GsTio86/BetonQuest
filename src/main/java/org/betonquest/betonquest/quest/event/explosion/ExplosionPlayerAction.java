 ...
 */
public class ExplosionPlayerAction implements Action {
    /**
     ...
     */
    public ExplosionPlayerAction(final CompoundLocation location, final VariableNumber power, final boolean setsFire, final boolean breaksBlocks) {

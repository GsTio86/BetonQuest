 ...
 */
public class PrimaryServerThreadPlayerAction extends PrimaryServerThreadEventFrame<PlayerAction> implements PlayerAction {
    /**
     ...
     */
    public PrimaryServerThreadPlayerAction(final PlayerAction syncedEvent, final Server server,

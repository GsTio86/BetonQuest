 ...
 */
public class ConversationPlayerAction implements PlayerAction {
    /**
     ...
     */
    public ConversationPlayerAction(final BetonQuestLoggerFactory loggerFactory, final ConversationID conversation, @Nullable final String startOption) {

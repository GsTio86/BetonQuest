...
import org.betonquest.betonquest.quest.event.tag.TagPlayerAction;
 ...
 */
public class CompassPlayerAction implements PlayerAction {
    /**
     ...
     */
    public CompassPlayerAction(final BetonQuestLogger log, final BetonQuest betonQuest, final PluginManager pluginManager,
    ...
    private void changeTag(final TagChanger tagChanger, final Profile profile) {
        new TagPlayerAction(betonQuest::getOfflinePlayerData, tagChanger).execute(profile);
    }
}

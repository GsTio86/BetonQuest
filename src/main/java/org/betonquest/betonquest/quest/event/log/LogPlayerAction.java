 ...
 */
public class LogPlayerAction implements Action {
    ...
    /**
     * Create a new {@link LogPlayerAction}.
     *
     ...
     */
    public LogPlayerAction(final BetonQuestLogger logger, final LogEventLevel level, final VariableString message) {
        this.logger = logger;

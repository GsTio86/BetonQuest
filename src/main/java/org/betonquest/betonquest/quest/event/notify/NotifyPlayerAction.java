 ...
 */
public class NotifyPlayerAction implements PlayerAction {
    /**
    ...
    /**
     * Creates a new {@link NotifyPlayerAction}.
     *
     * @param notifyIO     the {@link NotifyIO} to use
     * @param translations the translations to use
     */
    public NotifyPlayerAction(final NotifyIO notifyIO, final Map<String, VariableString> translations) {

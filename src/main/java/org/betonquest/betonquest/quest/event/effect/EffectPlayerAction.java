 ...
 */
public class EffectPlayerAction implements PlayerAction {
    /**
     * The effect to apply.
     */
     ...
     */
    public EffectPlayerAction(final PotionEffectType effect, final VariableNumber duration, final VariableNumber amplifier, final boolean ambient, final boolean hidden, final boolean icon) {
        this.effect = effect;

 ...
 */
public class TimePlayerAction implements Action {
    /**
     ...
     */
    public TimePlayerAction(final Time time, final VariableNumber rawTime, final Selector<World> worldSelector, final boolean hourFormat) {
        this.time = time;

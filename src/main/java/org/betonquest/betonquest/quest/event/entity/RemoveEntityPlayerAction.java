 ...
 */
public class RemoveEntityPlayerAction implements Action {
     ...
     */
    public RemoveEntityPlayerAction(final EntityType[] types, final CompoundLocation location, final VariableNumber radius,

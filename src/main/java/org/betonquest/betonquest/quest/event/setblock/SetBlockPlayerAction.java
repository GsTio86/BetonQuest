 ...
 */
public class SetBlockPlayerAction implements Action {
    /**
     * The block selector
     */
     ...
     */
    public SetBlockPlayerAction(final BlockSelector selector, final CompoundLocation compoundLocation, final boolean applyPhysics) {

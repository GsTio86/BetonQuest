 ...
 */
public class OnlineProfileGroupStaticEventAdapter implements StaticAction {
    /**
     ...
     */
    public OnlineProfileGroupStaticEventAdapter(final Supplier<? extends Iterable<? extends OnlineProfile>> profileSupplier, final PlayerAction event) {

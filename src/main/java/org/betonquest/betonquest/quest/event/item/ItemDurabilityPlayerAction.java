 ...
 */
public class ItemDurabilityPlayerAction implements PlayerAction {
    /**
     * The slot to target.
     */
     ...
     */
    public ItemDurabilityPlayerAction(final EquipmentSlot slot, final Point modification, final VariableNumber amount, final boolean ignoreUnbreakable, final boolean ignoreEvents, final Random random) {
        this.slot = slot;

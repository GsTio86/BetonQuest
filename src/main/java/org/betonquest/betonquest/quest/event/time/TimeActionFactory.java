 ...
 */
public class TimeActionFactory implements PlayerActionFactory, StaticActionFactory {
    /**
     ...
     */
    public TimeActionFactory(final Server server, final BukkitScheduler scheduler, final Plugin plugin) {
        this.server = server;
    ...
    public Action parseEvent(final Instruction instruction) throws InstructionParseException {
        ...
        return new PrimaryServerThreadAction(
                new TimePlayerAction(time, rawTime, worldSelector, hourFormat),

 ...
 */
public class ExperiencePlayerAction implements PlayerAction {
     ...
     */
    public ExperiencePlayerAction(final ExperienceModification experienceModification, final VariableNumber amount) {

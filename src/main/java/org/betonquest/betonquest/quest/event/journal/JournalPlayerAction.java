 ...
 */
public class JournalPlayerAction implements PlayerAction {
     ...
     */
    public JournalPlayerAction(final BetonQuest betonQuest, final JournalChanger journalChanger, final NotificationSender notificationSender) {

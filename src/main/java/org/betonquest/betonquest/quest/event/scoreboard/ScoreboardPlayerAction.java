 ...
 */
public class ScoreboardPlayerAction implements PlayerAction {
    /**
     ...
     */
    public ScoreboardPlayerAction(final String objective, final VariableNumber count, final ScoreModification scoreModification) {

...
public class CoreQuestTypes {
    ...
    private void registerEvents() {
        betonQuest.registerNonStaticEvent("burn", new BurnActionFactory(loggerFactory, server, scheduler, betonQuest));
        ...
        betonQuest.registerEvent("command", new CommandActionFactory(loggerFactory, server, scheduler, betonQuest));
        ...
        betonQuest.registerEvent("deleteglobalpoint", new DeleteGlobalPointActionFactory());
        ...
        betonQuest.registerEvent("drop", new DropActionFactory(server, scheduler, betonQuest));
        ...
        betonQuest.registerEvent("globaltag", new TagGlobalActionFactory(betonQuest));
        ...
        betonQuest.registerEvent("journal", new JournalActionFactory(loggerFactory, betonQuest, InstantSource.system(), betonQuest.getSaver()));
        ...
        betonQuest.registerEvent("notifyall", new NotifyAllActionFactory(loggerFactory, server, scheduler, betonQuest));
        ...
        betonQuest.registerEvent("runForAll", new RunForAllActionFactory());
        betonQuest.registerEvent("runIndependent", new RunIndependentActionFactory());
        ...
        betonQuest.registerEvent("tag", new TagPlayerActionFactory(betonQuest, betonQuest.getSaver()));
        ...
        betonQuest.registerEvent("time", new TimeActionFactory(server, scheduler, betonQuest));
        ...
        betonQuest.registerNonStaticEvent("weather", new WeatherActionFactory(loggerFactory, server, scheduler, betonQuest));
    }

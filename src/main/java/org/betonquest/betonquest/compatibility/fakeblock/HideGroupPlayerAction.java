 ...
 */
public class HideGroupPlayerAction implements PlayerAction {
    /**
     ...
     */
    public HideGroupPlayerAction(final List<String> groupNames, final RegisteredServiceProvider<PlayerGroupService> playerGroupService) {

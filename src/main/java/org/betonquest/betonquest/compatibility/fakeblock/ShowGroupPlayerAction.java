 ...
 */
public class ShowGroupPlayerAction implements PlayerAction {
    /**
     ...
     */
    public ShowGroupPlayerAction(final List<String> groupNames, final RegisteredServiceProvider<PlayerGroupService> playerGroupService) {

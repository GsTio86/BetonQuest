 ...
 */
public class CitizensMovePlayerAction implements PlayerAction {
    /**
     ...
     */
    public CitizensMovePlayerAction(final int npcId, final CitizensMoveController citizensMoveController, final CitizensMoveController.MoveData moveData) {
        this.npcId = npcId;
